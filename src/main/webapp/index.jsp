...
<head>
    ...
    <!-- 配置文件 -->
    <script type="text/javascript" src="./static/css/ueditor.config.js"></script>
    <!-- 编辑器源码文件 -->
    <script type="text/javascript" src="./static/css/ueditor.all.js"></script>
    <style type="text/css">
        body {
            padding-top: 60px;
            padding-bottom: 40px;
    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav">
                ...
                <li <c:if test="${menu_page=='note'}">class="active"</c:if>><a href="note"><i
                        class="glyphicon glyphicon-pencil"></i>&nbsp;发表云记</a></li>
                <li <c:if test="${menu_page=='type'}">class="active"</c:if>><a href="type"><i
                ...
                <li <c:if test="${menu_page=='report'}">class="active"</c:if>><a href="report"><i
